        ...
        <div className={styles.auth}>
          ...
          <form onSubmit={handleRegister}>
            ...
            <h6>
              ...
              Mesafəli <span onClick={() => navigate('/kargo-chatdirilma-shertleri')}>satış sözləşmesini</span> qəbul edirəm.
            </h6>
...
//   const [name, setName] = useState('');
//   const [surname, setSurname] = useState('');
//   const [birthDate, setBirthDate] = useState('');  // Düzenlendi: birthDate
//   const [email, setEmail] = useState('');
//   const [password, setPassword] = useState('');
//   const [confirmPassword, setConfirmPassword] = useState('');
...
//       navigate('/');
//     }
//   }, [userInfo, navigate]);  // Düzenlendi: userInfo eklendi
...
//     }
//     try {
//         const res = await register({ name, surname, birthDate, email, password }).unwrap();
//         dispatch(setCredentials({ ...res }));
//         navigate('/');
//     } catch (error) {
//         toast.error(error?.data?.message || 'Səhv: Qeydiyyat uğursuz oldu!');
...
//             <input
//               type="date"
//               name="birthDate"  // Düzenlendi: birthDate
//               placeholder="Doğum tarixi"
//               value={birthDate}
